package top.productivitytools.habits.api.security;
...
public class JwtTokenValidator {
    ...
    public boolean validateToken(String token) {
        try {
            // Parse the token without signature verification (for tokens signed by external providers like Google/Firebase)
